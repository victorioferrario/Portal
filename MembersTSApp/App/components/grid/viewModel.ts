    ...
    class DefaultView  {
        ...
        constructor(data: any) {
            ...
            self.filteredRows = ko.computed(function () {
                ...
                var tttt = typeof self.datasource !== "function" ? self.datasource : self.datasource();
            ...
            self.sortedRows = ko.computed(() => {
                //self.metrics = new web.components.grid.settings.PagerMetrics(self.filteredRows());
       ...
       getProductIcon(arg: any) {
        ...
        activate(data: any) {
            var self = this;
           // self.appContext.isLoading(true);
        ...
        onNextPage(data,event) {
            ...
            console.log(index, self.metrics.totalPages);
        ...
        onSelect(data,event,value) {
            ...
            console.log(arg);
                ...
                $( "#modalDetailsManager" ).removeClass( "m-hide" );
                $( "#modalDetailsManager" ).openModal( {
                    dismissible: false
                });

                ko.postbox.publish(
                    Env.system.events.Clinical.VIEW_DETAIL_CONTROL, value);
