...
MaterialLayout.prototype.drawerToggleHandler_ = function () {
    ...
    window["myClickOverride"] = MaterialLayout.prototype.drawerToggleHandler_;
/**
...
MaterialLayout.prototype.init = function () {
    if (this.element_) {
        ...
        if (this.drawer_) {
            ...
            var nodes = document.querySelectorAll('.' + "mdl-navigation__link");

            var me = this.drawerToggleHandler_.bind(this);
            $(".mdl-navigation__link").on('click',me);
        }
