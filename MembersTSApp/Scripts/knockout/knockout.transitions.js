(function (root, factory) {
    ...
    ko.bindingHandlers.animToggle = {
        ...
        update: function (element, valueAccessor) {
            ...
            $(element).stop(true, true);
            if (ko.utils.unwrapObservable(value)) {
                $(element).removeClass("animated-2 fadeOutLeft").addClass("animated-2 fadeInRight");
            } else {

                $(element).removeClass("animated-2 fadeInRight").addClass("animated-2 fadeOutLeft");
            }
        }
    };
